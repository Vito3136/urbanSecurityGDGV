...
if (lenBiggestGoodware > lenBiggestMalware):
    ...
    malware_bytecodes_filtered_with_Fibonacci_Index_Kernel_zero_padding = Parallel(n_jobs=NUM_CORES)(delayed(pad_bytecode)(b, lenDef) for b in malware_bytecodes_filtered_with_Fibonacci_Index_Kernel)
else:
...
print("Filtered with filter Fibonacci Index Kernel")
executeSVM(goodware_bytecodes_filtered_with_Fibonacci_Index_Kernel_zero_padding, malware_bytecodes_filtered_with_Fibonacci_Index_Kernel_zero_padding)

goodware_bytecodes_filtered_with_Fibonacci_Index_Kernel_zero_padding.clear()
malware_bytecodes_filtered_with_Fibonacci_Index_Kernel_zero_padding.clear()
gc.collect()
end = time.time()
